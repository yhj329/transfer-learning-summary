...
#sp2-3
set.seed(165)
  targetbeta=c(-5,0.2,0.14,0.3,0.6,0.1)

betaxin_total=external_infor(target_beta =targetbeta,NN = 50000,m=1000)

final_try<-simu_glm(type_ini = 1,source_beta =targetbeta,ns=2000,nt = 2000,vartype = 3,N_r =1000,al_type ="NLOPT_LD_MMA",random_target = T,nr=1000 )
...
assesment_r1<-assesment(result = final_try,targetbeta = targetbeta)
 ...
 # sp1
 set.seed(165)
betaxin_total=external_infor(target_beta =c(-2.4,-0.5,0.4,0.3,0.65,0.1),NN = 4000,m=1000)

final_try<-simu_glm(type_ini = 1,source_beta =c(-2.4,-0.5,0.4,0.3,0.65,0.1),ns=2000,nt = 4000,vartype = 3,N_r =1000,al_type ="NLOPT_LD_MMA",random_target = T )
...
final_try<-simu_glm(type_ini = 1,source_beta =c(-2.4,-0.5,0.4,0.3,0.65,0.1),ns=500,nt = 50000,vartype = 0,N_r =1000,al_type ="NLOPT_LD_MMA",random_target = T )
